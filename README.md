...
Scenario playbooks are predefined under `scenarios/`:

1. `001-payment-timeout.md`
2. `002-inventory-consistency.md`
3. `003-notification-backlog.md`
4. `004-kafka-consumer-lag.md`
5. `005-pubsub-publish-failure.md`
6. `006-resttemplate-connectivity.md`
